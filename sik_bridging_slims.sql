...
--
-- Host: localhost
-- Waktu pembuatan: 24 Jul 2024 pada 23.38
...
--
-- Database: `sik_bridging_slims`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `detail_hasil_lab`
--
...
--
-- Dumping data untuk tabel `detail_hasil_lab`
--

INSERT INTO `detail_hasil_lab` (`noorder`, `kd_jenis_prw`, `id_template`, `nilai`, `nilai_rujukan`, `keterangan`) VALUES
('PK202407240164', 'J000011', 3276, 'coba kirim', 'tess', 'H'),
('PK202407240173', 'J000218', 3466, 'coba1', '111', 'L'),
('PK202407240173', 'J000218', 3467, 'coba2', '222', 'H'),
('PK202407240173', 'J000218', 3468, 'coba3', '333', 'L');

-- --------------------------------------------------------

--
-- Struktur dari tabel `detail_permintaan_lab`
--
...
--
-- Dumping data untuk tabel `detail_permintaan_lab`
--

INSERT INTO `detail_permintaan_lab` (`noorder`, `kd_jenis_prw`, `id_template`) VALUES
('PK202407240164', 'J000011', 3276),
('PK202407240173', 'J000218', 3466),
('PK202407240173', 'J000218', 3467),
('PK202407240173', 'J000218', 3468),
...
--
-- Struktur dari tabel `duplikat_permintaan_lab`
--

CREATE TABLE `duplikat_permintaan_lab` (
  `noorder` varchar(25) NOT NULL,
  `status` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `duplikat_permintaan_lab`
--

INSERT INTO `duplikat_permintaan_lab` (`noorder`, `status`) VALUES
('PK202407240173', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `HisToLisDetail`
--
...
--
-- Dumping data untuk tabel `HisToLisDetail`
--

INSERT INTO `HisToLisDetail` (`RowID`, `HisToLisHeaderID`, `HisKodeTest`, `Cito`, `tgl_insert`, `Qty`) VALUES
(1, 5, '665', 'N', '2021-10-05 00:00:00', 0),
(2, 5, '666', 'N', '2021-10-05 00:00:00', 0),
(3, 5, '667', 'N', '2021-10-05 00:00:00', 0),
(4, 5, '668', 'N', '2021-10-05 00:00:00', 0),
(5, 5, '669', 'N', '2021-10-05 00:00:00', 0),
(6, 5, '670', 'N', '2021-10-05 00:00:00', 0),
(7, 5, '671', 'N', '2021-10-05 00:00:00', 0),
(8, 5, '672', 'N', '2021-10-05 00:00:00', 0),
(9, 5, '673', 'N', '2021-10-05 00:00:00', 0),
(10, 5, '674', 'N', '2021-10-05 00:00:00', 0),
(11, 5, '675', 'N', '2021-10-05 00:00:00', 0),
(12, 5, '2198', 'N', '2021-10-05 00:00:00', 0),
(13, 5, '2199', 'N', '2021-10-05 00:00:00', 0),
(14, 5, '2200', 'N', '2021-10-05 00:00:00', 0),
(15, 5, '2201', 'N', '2021-10-05 00:00:00', 0),
(16, 5, '2202', 'N', '2021-10-05 00:00:00', 0),
(17, 6, '665', 'N', '2021-10-14 00:00:00', 0),
(18, 6, '666', 'N', '2021-10-14 00:00:00', 0),
(19, 6, '667', 'N', '2021-10-14 00:00:00', 0),
(20, 6, '668', 'N', '2021-10-14 00:00:00', 0),
(21, 6, '669', 'N', '2021-10-14 00:00:00', 0),
(22, 6, '670', 'N', '2021-10-14 00:00:00', 0),
(23, 6, '671', 'N', '2021-10-14 00:00:00', 0),
(24, 6, '672', 'N', '2021-10-14 00:00:00', 0),
(25, 6, '673', 'N', '2021-10-14 00:00:00', 0),
(26, 6, '674', 'N', '2021-10-14 00:00:00', 0),
(27, 6, '675', 'N', '2021-10-14 00:00:00', 0),
(28, 6, '2198', 'N', '2021-10-14 00:00:00', 0),
(29, 6, '2199', 'N', '2021-10-14 00:00:00', 0),
(30, 6, '2200', 'N', '2021-10-14 00:00:00', 0),
(31, 6, '2201', 'N', '2021-10-14 00:00:00', 0),
(32, 6, '2202', 'N', '2021-10-14 00:00:00', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `HisToLisHeader`
--
...
--
-- Dumping data untuk tabel `HisToLisHeader`
--

INSERT INTO `HisToLisHeader` (`RowID`, `HisNoReg`, `HisNoOrder`, `Ipop`, `NoRM`, `NamaPasien`, `JenisKelamin`, `TglLahir`, `AlamatPasien`, `KodeRuang`, `Ruangan`, `KodeDokterKlinisi`, `NamaDokterKlinisi`, `KodeDokter`, `DokterKodePJ`, `Diagnosa`, `JenisPasien`, `Kelas`, `flag_lempar`, `DetailCount`, `copyorder`, `NoSample`, `NamaDokterPJ`, `Action`, `UnitPengirim`, `Rujukan`, `Status`, `HisTanggalKirim`, `LisTanggalTerima`) VALUES
(5, '2021/10/05/000002', 'PL202110050001', 'Rawat Jalan', '000001', 'WINDIARTO', 'L', '1988-02-24 00:00:00', ', -, -, -, -', 'INT', 'INT Poli Penyakit Dalam', 'D0000002', 'dr. Aisyah', 'D0000002', 'dr. Aisyah', '-', 'UMUM', 'Ralan', '0', 16, '0', 'PL202110050001', 'dr. Aisyah', 'A', 'INT Poli Penyakit Dalam', 'N', '0', '2021-10-05 00:00:00', '2021-10-05 00:00:00'),
(6, '2021/09/22/000001', 'PL202110140001', 'Rawat Inap', '-', '-', 'L', '2021-09-22 00:00:00', ', -, -, -, -', 'K1', 'Kamar Kelas I', 'D0000002', 'dr. Aisyah', 'D0000002', 'dr. Aisyah', '-', 'UMUM', 'Kelas 1', '0', 16, '0', 'PL202110140001', 'dr. Aisyah', 'A', 'K1.01', 'N', '0', '2021-10-14 00:00:00', '2021-10-14 00:00:00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `LIS_ORDER`
--
...
--
-- Dumping data untuk tabel `LIS_ORDER`
--
...
--
-- Struktur dari tabel `LIS_ORDER_DETAIL`
--
...
INSERT INTO `permintaan_lab` (`noorder`, `no_rawat`, `no_rkm_medis`, `nm_pasien`, `email`, `jk`, `tmp_lahir`, `tgl_lahir`, `alamat`, `tgl_permintaan`, `jam_permintaan`, `kode_dokter_perujuk`, `dokter_perujuk`, `status`, `kode_ruang`, `nama_ruang`, `kode_carabayar`, `nama_carabayar`, `informasi_tambahan`, `diagnosa_klinis`) VALUES
('PL202004050001', '2020/04/05/000001', '020324', 'AGUS BUDIYONO', '-', 'L', '-', '1986-12-17', 'GRESIK, SEKAPUK, SEKAPUK, GRESIK, JAWA TIMUR', '2020-04-05', '07:01:45', 'D0000045', 'dr. ADHARI AJI PURNOMO', 'ralan', 'INT', 'INT Poli Penyakit Dalam', 'A08', 'Asuransi BNI Life', '1', '2'),
('PL202004050003', '2020/03/26/000002', '020323', 'SAIFUL UMAM', '-', 'L', '-', '1986-01-10', 'ALAMAT, -, -, -, -', '2020-04-05', '09:14:01', 'D0000041', 'dr. BAMBANG KURNIAWAN, Sp.OG', 'ranap', 'I A1', 'Kamar Kelas I', 'A65', 'BPJS', '1', '2'),
('PK202407240164', '2024/07/24/684993', '222796', 'TEST2', '-', 'L', '-', '1968-06-12', 'TANJUNG HARAPAN 2/2 ABUNG SELATAN, -, -, Kab. Lampung Utara, LAMPUNG', '2024-07-24', '21:24:53', 'D0000028', 'dr. Sariningsih, Sp.S.,M.Kes', 'ralan', 'KLT', 'KULIT & KELAMIN', 'BPJ', 'BPJS', 'pasien test bridging', 'pasien test bridging'),
('PK202407240173', '2024/07/24/684993', '222796', 'TEST2', '-', 'L', '-', '1968-06-12', 'TANJUNG HARAPAN 2/2 ABUNG SELATAN, -, -, Kab. Lampung Utara, LAMPUNG', '2024-07-24', '22:28:55', 'D0000028', 'dr. Sariningsih, Sp.S.,M.Kes', 'ralan', 'KLT', 'KULIT & KELAMIN', 'BPJ', 'BPJS', 'test chan', 'test chan');

--
-- Trigger `permintaan_lab`
--
DELIMITER $$
CREATE TRIGGER `copy_permintaan_lab` AFTER INSERT ON `permintaan_lab` FOR EACH ROW BEGIN
    INSERT INTO duplikat_permintaan_lab (noorder)
    VALUES (NEW.noorder);
END
$$
DELIMITER ;
...
--
-- Indeks untuk tabel `detail_hasil_lab`
--
ALTER TABLE `detail_hasil_lab`
  ADD PRIMARY KEY (`noorder`,`kd_jenis_prw`,`id_template`);

--
-- Indeks untuk tabel `detail_permintaan_lab`
--
ALTER TABLE `detail_permintaan_lab`
  ADD PRIMARY KEY (`noorder`,`kd_jenis_prw`,`id_template`);

--
-- Indeks untuk tabel `HisToLisDetail`
--
ALTER TABLE `HisToLisDetail`
  ADD PRIMARY KEY (`RowID`);

--
-- Indeks untuk tabel `HisToLisHeader`
--
ALTER TABLE `HisToLisHeader`
  ADD PRIMARY KEY (`RowID`);

--
-- Indeks untuk tabel `LIS_ORDER`
--
...
--
-- Indeks untuk tabel `LIS_ORDER_DETAIL`
--
...
--
-- Indeks untuk tabel `permintaan_lab`
--
ALTER TABLE `permintaan_lab`
  ADD PRIMARY KEY (`noorder`);

--
-- Indeks untuk tabel `RESDT`
--
ALTER TABLE `RESDT`
...
--
-- AUTO_INCREMENT untuk tabel `HisToLisDetail`
--
ALTER TABLE `HisToLisDetail`
  MODIFY `RowID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT untuk tabel `HisToLisHeader`
--
ALTER TABLE `HisToLisHeader`
  MODIFY `RowID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `LIS_ORDER`
--
ALTER TABLE `LIS_ORDER`
  MODIFY `ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `LIS_ORDER_DETAIL`
--
ALTER TABLE `LIS_ORDER_DETAIL`
  MODIFY `ID` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `RESDT`
--
ALTER TABLE `RESDT`
  MODIFY `ID` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `RESHD`
--
ALTER TABLE `RESHD`
  MODIFY `ID` bigint(20) NOT NULL AUTO_INCREMENT;
COMMIT;
