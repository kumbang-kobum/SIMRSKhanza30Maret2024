...
public class frmUtama extends javax.swing.JFrame {
    ...
    private  String requestJson,URL="",utc="",link="",datajam="",
              nol_jam = "",nol_menit = "",nol_detik = "",jam="",menit="",detik="",hari="",nomorreferensi="",status="1",noresep="",task3="",task4="",task5="",task6="",task7="",task99="",
    ...
    private void initComponents() {
        ...
        setTitle("Khanza Service JKN Cah Way Kanan");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(detik.equals("01")&&((nilai_menit%5)==0)){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                                "SELECT referensi_mobilejkn_bpjs.nobooking,referensi_mobilejkn_bpjs.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,referensi_mobilejkn_bpjs.nohp,referensi_mobilejkn_bpjs.nomorkartu,"+
                                "referensi_mobilejkn_bpjs.nik,referensi_mobilejkn_bpjs.tanggalperiksa,poliklinik.nm_poli,dokter.nm_dokter,dokter.kd_dokter,referensi_mobilejkn_bpjs.jampraktek,"+
                                "referensi_mobilejkn_bpjs.jeniskunjungan,referensi_mobilejkn_bpjs.nomorreferensi,referensi_mobilejkn_bpjs.status,referensi_mobilejkn_bpjs.validasi,"+
                                "referensi_mobilejkn_bpjs.kodepoli,referensi_mobilejkn_bpjs.pasienbaru,referensi_mobilejkn_bpjs.kodedokter,referensi_mobilejkn_bpjs.jampraktek,"+
                                "referensi_mobilejkn_bpjs.nomorantrean,referensi_mobilejkn_bpjs.angkaantrean,referensi_mobilejkn_bpjs.estimasidilayani,referensi_mobilejkn_bpjs.sisakuotajkn,"+
                                "referensi_mobilejkn_bpjs.kuotajkn,referensi_mobilejkn_bpjs.sisakuotanonjkn,referensi_mobilejkn_bpjs.kuotanonjkn "+
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                if(task3.equals("")){
                                    datajam=Sequel.cariIsi("select concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat='"+rs.getString("no_rawat")+"'and pemeriksaan_ralan.nip NOT LIKE '"+rs.getString("kd_dokter")+"'ORDER BY pemeriksaan_ralan.jam_rawat ASC"); //kostum
                                    if(!datajam.equals("")){
                                ...
                                if(task4.equals("")){
                                    datajam=Sequel.cariIsi("select concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat='"+rs.getString("no_rawat")+"'and pemeriksaan_ralan.nip='"+rs.getString("kd_dokter")+"'ORDER BY pemeriksaan_ralan.jam_rawat ASC"); //kostum
                                    if(!datajam.equals("")){
                                ...
                                if(task5.equals("")){
                                    datajam=Sequel.cariIsi("select sudah from mutasi_berkas where mutasi_berkas.sudah<>'0000-00-00 00:00:00' and mutasi_berkas.no_rawat='"+rs.getString("no_rawat")+"'"); // '"+rs.getString("no_rawat")+"'
                                    if(!datajam.equals("")){
...
//                                if(task3.equals("")){ //task id baru
//                                    datajam=Sequel.cariIsi("select waktu from novan_taskid where novan_taskid.taskid='3' and novan_taskid.waktu<>'0000-00-00 00:00:00' and novan_taskid.no_rawat='"+rs.getString("no_rawat")+"'"); // '"+rs.getString("no_rawat")+"'
//                                    if(!datajam.equals("")){
//                                        if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"3",datajam})==true){
//                                            parsedDate = dateFormat.parse(datajam);
//                                            try {     
...
//                                }
//                                
//                                if(task4.equals("")){ //task id baru
//                                    datajam=Sequel.cariIsi("select waktu from novan_taskid where novan_taskid.taskid='4' and novan_taskid.waktu<>'0000-00-00 00:00:00' and novan_taskid.no_rawat='"+rs.getString("no_rawat")+"'"); // '"+rs.getString("no_rawat")+"'
//                                    if(!datajam.equals("")){
//                                        if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"4",datajam})==true){
//                                            parsedDate = dateFormat.parse(datajam);
//                                            try {     
...
//                                }
//                                
//                                if(task5.equals("")){ //task id baru
//                                    datajam=Sequel.cariIsi("select waktu from novan_taskid where novan_taskid.taskid='5' and novan_taskid.waktu<>'0000-00-00 00:00:00' and novan_taskid.no_rawat='"+rs.getString("no_rawat")+"'"); // '"+rs.getString("no_rawat")+"'
//                                    if(!datajam.equals("")){
//                                        if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"5",datajam})==true){
//                                            parsedDate = dateFormat.parse(datajam);
//                                            try {     
...
//                                } 
                                ...
                                if(task6.equals("")){
                                    ...
                                    datajam=Sequel.cariIsi("select concat(resep_obat.tgl_peresepan,' ',resep_obat.jam_peresepan) from resep_obat where resep_obat.tgl_perawatan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.no_rawat=?",rs.getString("no_rawat"));
...
//                                    datajam=Sequel.cariIsi("select concat(resep_obat.tgl_penyerahan,' ',resep_obat.jam_penyerahan) from resep_obat where resep_obat.status='ralan' and resep_obat.no_rawat=? and concat(resep_obat.tgl_penyerahan,' ',resep_obat.jam_penyerahan)<>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                        ...
                        //pasien Non JKN Novan
                        TeksArea.append("Menjalankan WS Novan tambah antrian Mobile JKN Pasien Non BPJS/BPJS On Site\n");
                        ps=koneksi.prepareStatement(
                                    ...
                                    if(rs2.next()){
                                        ...
                                        if((!kodedokter.equals(""))&&(!kodepoli.equals(""))){
                                            try {     
                                                    ...
                                                    parsedDate = dateFormat.parse(datajam);
                                                    nomorreferensi = Sequel.cariIsi("SELECT bridging_sep.no_rujukan FROM bridging_sep WHERE bridging_sep.no_rawat = ?", rs.getString("no_rawat"));

                                                    if (nomorreferensi.equals("")) {
                                                        nomorreferensi = Sequel.cariIsi("SELECT bridging_sep_internal.no_rujukan FROM bridging_sep_internal WHERE bridging_sep_internal.no_rawat = ?", rs.getString("no_rawat"));
                                                        if (!nomorreferensi.equals("")) {
                                                            status = "2";
                                                        }
                                                        if (nomorreferensi.equals("")) {
                                                            nomorreferensi = Sequel.cariIsi("SELECT bridging_sep.noskdp FROM bridging_sep WHERE bridging_sep.no_rawat = ?", rs.getString("no_rawat"));
                                                            if (!nomorreferensi.equals("")) {
                                                                status = "3";
                                                            }
                                                        }
                                                    } else {
                                                        if (nomorreferensi.equals("1") || nomorreferensi.equals("4")) {
                                                            // Validasi kesesuaian NOKA JKN dengan No Rujukan untuk kunjungan pertama dengan no rujukan baru
                                                            // ...
                                                            status = "2";
                                                        } else if (nomorreferensi.equals("3")) {
                                                            // Validasi kesesuaian No JKN dengan No Surat Kontrol untuk kunjungan kontrol poli yang sama
                                                            // ...
                                                            status = "3";
                                                        } else if (nomorreferensi.equals("2")) {
                                                            // ...
                                                            status = "2";
                                                        }
                                                    }
