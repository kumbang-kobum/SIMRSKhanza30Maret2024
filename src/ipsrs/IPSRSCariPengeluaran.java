  ...
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim().equals("")){
     ...
     try {
         ...
         try {
            ...
            if(sukses==true){
                sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(),"U","K043 PEMBATALAN PENGGUNAAN BARANG NON MEDIS"+", OLEH "+akses.getkode());//tambah chan
            }
