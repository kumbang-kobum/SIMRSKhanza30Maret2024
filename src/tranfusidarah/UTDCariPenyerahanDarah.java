                    ...
                    try {
                        ...
                        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString().equals("Sudah Dibayar")){
                            ...
                            if(sukses==true){
                                ...
                                if(sukses==true){
                                    sukses=jur.simpanJurnal(nopenyerahan.getText(),"U","K156 PEMBATALAN PENJUALAN DARAH DI UTD"+", OLEH "+akses.getkode());//tambah chan
                                }
                            }
                        }
                    } catch (Exception e) {
                ...
                try {
                    if(tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString().equals("Belum Dibayar")){ 
                        ...
                        if(sukses==true){
                            ...
                            sukses=jur.simpanJurnal(nopenyerahan.getText(),"U","K157 PENJUALAN DARAH DI UTD"+", OLEH "+akses.getkode());  //tambah chan
                        }
