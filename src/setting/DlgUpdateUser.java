...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            catatan_observasi_hemodialisa=false,skrining_kesehatan_gigi_mulut_dewasa=false,persetujuan_pernyataan_pemilihan_dpjp=false,grafik_harian_pasien_prb=false;//tambah chan 2
        ...
        try{    
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    persetujuan_pernyataan_pemilihan_dpjp=rs.getBoolean("persetujuan_pernyataan_pemilihan_dpjp");grafik_harian_pasien_prb=rs.getBoolean("grafik_harian_pasien_prb");//tambah chan
                    setTampil();
                }       
