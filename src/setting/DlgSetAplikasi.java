...
public class DlgSetAplikasi extends javax.swing.JDialog {
    ...
    public DlgSetAplikasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Faskes","Alamat","Kota","Propinsi","Aktifkan?","Wallpaper","KontaK","Email","Logo","Kode PPK BPJS","Kode PPK Inhealth","Kode PPK Kemenkes","Kode Apotek BPJS"};//Apotek
        ...
        for (int i = 0; i < 13; i++) {//Apotek tambah 1
        ...
        kdPPK3.setDocument(new batasInput((byte)15).getKata(kdPPK3));//Apotek Tambah 1
    }
    ...
    private void initComponents() {
        ...
        label44.setBounds(490, 250, 120, 23);
        ...
        kdPPK2.setBounds(620, 250, 110, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Sequel.menyimpan("setting","'"+Nm.getText()+"','"+Almt.getText()+"','"+Kota.getText()+
                             ...
                             "','"+YesNo.getSelectedItem()+"','"+kdPPK.getText()+"','"+kdPPK1.getText()+"','"+kdPPK2.getText()+"','"+kdPPK3.getText()+"'","Setting",EGb,ELogo);//Apotek
            tampil();
        }else if(tabMode.getRowCount()>0){
    ...
    */
    ...
    private void tampil() {
        String sql="select nama_instansi, alamat_instansi, kabupaten, propinsi, aktifkan, wallpaper,kontak,email,logo,kode_ppk,kode_ppkinhealth,kode_ppkkemenkes,kode_apotek from setting";//Apotek Tambah 1
        prosesCari(sql);
    }
        ...
        try{
            ...
            while(rs.next()){
                Object[] data={rs.getString(1),rs.getString(2),rs.getString(3),
                               ...
                               rs.getString(10),rs.getString(11),rs.getString(12),rs.getString(13)//Apotek Tambah 1
                };
                tabMode.addRow(data);
            }
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            kdPPK3.setText(tabMode.getValueAt(row,12).toString());//Apotek Tambah 1
