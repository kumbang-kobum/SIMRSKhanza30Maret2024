/*//GEN-FIRST:event_BtnHapusActionPerformed
  Dilarang keras menggandakan/mengcopy/menyebarkan/membajak/mendecompile//GEN-LAST:event_BtnHapusActionPerformed
...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[L]Rekap Keluar Duta Parking","[P]Surat Keterangan Layak Terbang","[K]Bayar Beban Hutang Lain","[P]Persetujuan Dokter DPJP","[O]pasien PRB Per Tanggal","[M]Pengkajian Lanjutan Resiko Time UP And GO"//tambah chan 3 diakhir
        };
        ...
        for (i = 0; i < 1145;i++) {//tambah chan 3
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("user","AES_ENCRYPT('"+TKd.getText()+"','nur'),AES_ENCRYPT('"+TPass.getText()+"','windi'),'false','false','false','false','false','false','false','false',"+
                    ...
                    "'false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false',"+
                    "'false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false',"+
                    "'false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false','false'","User")==true){//tambah chan 3 akhir
                tabMode.addRow(new Object[]{
                    ...
                    false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,
                    false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,
                    false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false//tambah chan 3 akhir
                });
                emptTeks();
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "persetujuan_pernyataan_pemilihan_dpjp='"+tbUser.getValueAt(i, 1142).toString()+"',"+//tambah chan
                    "grafik_harian_pasien_prb='"+tbUser.getValueAt(i,1143).toString()+"',"+//tambah chan
                    "pengkajian_resiko_jatuh_timeup='"+tbUser.getValueAt(i,1144).toString()+"'")==true){//tambah chan
                    emptTeks();
                }
            }         
        }
    ...
    private void TKdKeyPressed(java.awt.event.KeyEvent evt) {                               
    ...
    private void BtnSeekKeyPressed(java.awt.event.KeyEvent evt) {                                   
        Valid.pindah(evt,TKd,TPass);
}                                  

    private void BtnSeek1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        dlgpetugas.emptTeks();
        dlgpetugas.isCek();
    ...
    private void BtnSeek1KeyPressed(java.awt.event.KeyEvent evt) {                                    
        Valid.pindah(evt,TKd,TPass);
}                                   

    private void TNmUserKeyPressed(java.awt.event.KeyEvent evt) {                                   
...
private void BtnPrintKeyPressed(java.awt.event.KeyEvent evt) {                                    
    ...
    private void MnCopyHakAksesActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if(tabMode.getRowCount()==0){
    ...
    private void MnSetUserActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if(tbUser.getSelectedRow()!= -1){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "persetujuan_pernyataan_pemilihan_dpjp='"+tbUser.getValueAt(barisdicopy, 1142).toString()+"',"+//tambah chan
                                        "grafik_harian_hemodialisa='"+tbUser.getValueAt(barisdicopy,1143).toString()+"',"+//tambah chan
                                        "pengkajian_resiko_jatuh_timeup='"+tbUser.getValueAt(i,1144).toString()+"'");//tambah chan
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
    ...
    private void tbUserKeyPressed(java.awt.event.KeyEvent evt) {                                  
        if(tabMode.getRowCount()!=0){
    ...
    private void JabatanKeyPressed(java.awt.event.KeyEvent evt) {                                   
        // TODO add your handling code here:
    }                                  
