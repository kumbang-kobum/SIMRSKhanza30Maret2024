...
import bridging.koneksiDBSLIMS;//tambah chan keperluan slims
...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirimSlims = new widget.Button();
        BtnAmbilSlims = new widget.Button();
        ...
        BtnKirimSlims.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimSlims.setText("Kirim Permintaan ke SLIMS");
        BtnKirimSlims.setFocusPainted(false);
        BtnKirimSlims.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimSlims.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimSlims.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimSlims.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimSlims.setName("BtnKirimSlims"); // NOI18N
        BtnKirimSlims.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKirimSlims.setRoundRect(false);
        BtnKirimSlims.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimSlimsActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimSlims);

        BtnAmbilSlims.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAmbilSlims.setText("Ambil Hasil dari SLIMS");
        BtnAmbilSlims.setFocusPainted(false);
        BtnAmbilSlims.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAmbilSlims.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAmbilSlims.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAmbilSlims.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAmbilSlims.setName("BtnAmbilSlims"); // NOI18N
        BtnAmbilSlims.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAmbilSlims.setRoundRect(false);
        BtnAmbilSlims.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilSlimsActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAmbilSlims);
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnKirimSlimsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimSlimsActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){//tambah chan
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    Valid.textKosong(TCari,"No.Permintaan");
    ...
    }//GEN-LAST:event_BtnKirimSlimsActionPerformed

    private void BtnAmbilSlimsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilSlimsActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){//tambah chan
            if(TabRawatJalan.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnAmbilSlimsActionPerformed
    ...
    */
    ...
    private widget.Button BtnAmbilSlims;
    ...
    private widget.Button BtnKirimSlims;
