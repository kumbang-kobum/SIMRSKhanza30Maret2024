package permintaan;//GEN-FIRST:event_BtnHapusActionPerformed
import bridging.ApiCareStream;//GEN-LAST:event_BtnHapusActionPerformed
...
*/
    ...
    private void Tgl2KeyPressed(java.awt.event.KeyEvent evt) {                                
...
private void tbRadiologiRalanMouseClicked(java.awt.event.MouseEvent evt) {                                              
    if(tabMode.getRowCount()!=0){
            try {
                getData();
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {                                            
   if(tabMode.getRowCount()!=0){
    ...
    private void TabRawatJalanMouseClicked(java.awt.event.MouseEvent evt) {                                           
        TeksKosong();
        pilihRalan();
    }                                          

    private void tbRadiologiRalan2MouseClicked(java.awt.event.MouseEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void tbRadiologiRalan2KeyPressed(java.awt.event.KeyEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void BtnSampelActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tbRadiologiRalan.getSelectedRow()!= -1){
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void BtnSampelKeyPressed(java.awt.event.KeyEvent evt) {                                     
        // TODO add your handling code here:
    }                                    
    ...
    private void BtnHasilKeyPressed(java.awt.event.KeyEvent evt) {                                    
        // TODO add your handling code here:
    }                                   

    private void BtnCloseIn4ActionPerformed(java.awt.event.ActionEvent evt) {                                            
        WindowAmbilSampel.dispose();
    }                                           

    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void TabPilihRawatMouseClicked(java.awt.event.MouseEvent evt) {                                           
        TeksKosong();
        pilihTab();
    }                                          

    private void tbRadiologiRanapMouseClicked(java.awt.event.MouseEvent evt) {                                              
        if(tabMode3.getRowCount()!=0){
            try {
                getData2();
            } catch (java.lang.NullPointerException e) {
    ...
    private void tbRadiologiRanapKeyPressed(java.awt.event.KeyEvent evt) {                                            
        if(tabMode3.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getData2();
    ...
    private void tbRadiologiRanap2MouseClicked(java.awt.event.MouseEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void tbRadiologiRanap2KeyPressed(java.awt.event.KeyEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void TabRawatInapMouseClicked(java.awt.event.MouseEvent evt) {                                          
        TeksKosong();
        pilihRanap();
    }                                         
    ...
    private void BtnCetakHasilRadiologiActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void BtnBarcodePermintaanActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    Valid.textKosong(TCari,"No.Permintaan");
    ...
    private void BtnBarcodePermintaan2ActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    Valid.textKosong(TCari,"No.Permintaan");
    ...
    private void BtnKirimDataFujiActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if(!NoRawat.equals("")){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            if(NoPermintaan.trim().equals("")){
                Valid.textKosong(TCari,"No.Permintaan");
    ...
    private void BtnAmbilDataFUJIActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tbRadiologiRalan.getSelectedRow()!= -1){
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void BtnKirimDataCareStreamActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
    ...
    private void BtnAmbilDataFUJI1ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tbRadiologiRalan.getSelectedRow()!= -1){
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
