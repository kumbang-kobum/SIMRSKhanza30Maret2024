...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(173, 216, 230, 64);
    private final Color dark = new Color(100, 149, 237, 128);
    private final Color black = new Color(25, 25, 112);
    private final Color warna = new Color(70, 130, 180);
