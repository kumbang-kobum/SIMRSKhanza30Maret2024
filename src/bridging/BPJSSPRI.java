...
public class BPJSSPRI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnSurat1.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2024" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    if(tbObat.getSelectedRow() != -1) {//tambah chan
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
        Map<String, Object> param = new HashMap<>();
        param.put("namars", akses.getnamars());
        param.put("alamatrs", akses.getalamatrs());
        ...
        Valid.MyReportqry(
            "rptGabunganSurat.jasper", 
            "report", 
            "::[ Gabungan Surat PRI dan Surat Keterangan Covid ]::",
