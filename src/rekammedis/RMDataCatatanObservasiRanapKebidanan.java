...
public final class RMDataCatatanObservasiRanapKebidanan extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiRanapKebidanan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "HR(x/menit)","RR(x/menit)","Suhu(°C)","SpO2(%)","Kontraksi/HIS","BJJ","PPV","VT","Keterangan","NIP","Nama Petugas" //tambah chan
        }){
        ...
        Keterangan.setDocument(new batasInput((byte)30).getKata(VT));//tambah chan
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(NIP.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString())){//tambah chan
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanObservasiRanapKebidanan.jasper","report","::[ Data Catatan Observasi Rawat Inap Kebidanan ]::",
                    ...
                    "catatan_observasi_ranap_kebidanan.kontraksi,catatan_observasi_ranap_kebidanan.bjj,catatan_observasi_ranap_kebidanan.ppv,catatan_observasi_ranap_kebidanan.vt,catatan_observasi_ranap_kebidanan.keterangan,"+ //tambah chan
    ...
    private void KeteranganKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeteranganKeyPressed
        Valid.pindah(evt,VT,BtnSimpan); //tambah chan
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("bjj"),rs.getString("ppv"),rs.getString("vt"),rs.getString("keterangan"),rs.getString("nip"),rs.getString("nama") //tambah chan
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Keterangan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());//tambah chan
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_observasi_ranap_kebidanan","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,"+
            "hr=?,rr=?,suhu=?,spo2=?,kontraksi=?,bjj=?,ppv=?,vt=?,keterangan=?,nip=?",18,new String[]{ //tambah chan
            ...
            TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),SPO.getText(),Kontraksi.getText(),BJJ.getText(),PPV.getText(),VT.getText(),Keterangan.getText(),NIP.getText(),//tambah chan
            ...
            tbObat.setValueAt(Keterangan.getText(),tbObat.getSelectedRow(),18);//tambah chan
            tbObat.setValueAt(NIP.getText(),tbObat.getSelectedRow(),19);//tambah chan
            tbObat.setValueAt(NamaPetugas.getText(),tbObat.getSelectedRow(),20);//tambah chan
            emptTeks();
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("catatan_observasi_ranap_kebidanan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",15,new String[]{//tambah chan
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),GCS.getText(),
            ...
            tabMode.addRow(new Object[]{
                ...
                VT.getText(),Keterangan.getText(),NIP.getText(),NamaPetugas.getText()//tambah chan
            });
            LCount.setText(""+tabMode.getRowCount());
            emptTeks();
        } 
