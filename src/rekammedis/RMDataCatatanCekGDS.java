...
public final class RMDataCatatanCekGDS extends javax.swing.JDialog {
    ...
    */
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_cek_gds","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gdp=?,insulin=?,obat_gula=?,gds=?,nip=?",11,new String[]{//tambah chan
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
