...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Tgl.Rawat/keluar :");
        ...
        BtnCari1.setText("keluar");
        BtnCari1.setToolTipText("Alt+3");
        BtnCari1.setName("BtnCari1"); // NOI18N
        BtnCari1.setPreferredSize(new java.awt.Dimension(85, 23));
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-03-2025 10:52:45" }));
...
public void tampilkeluar() {
    ...
    try {
        ps = koneksi.prepareStatement(
            ...
            "INNER JOIN penjab ON penjab.kd_pj = reg_periksa.kd_pj " +
            "INNER JOIN kamar_inap ON kamar_inap.no_rawat = reg_periksa.no_rawat " + // Bergabung dengan kamar_inap untuk mengakses tgl_keluar
            "WHERE kamar_inap.tgl_keluar BETWEEN ? AND ? " + // Mengubah kondisi pencarian berdasarkan tgl_keluar
            (TCari.getText().trim().equals("") ? "" : "AND (reg_periksa.no_rkm_medis LIKE ? OR pasien.nm_pasien LIKE ? OR resume_pasien_ranap.kd_dokter LIKE ? OR " +
            "dokter.nm_dokter LIKE ? OR resume_pasien_ranap.keadaan LIKE ? OR resume_pasien_ranap.kd_diagnosa_utama LIKE ? OR resume_pasien_ranap.diagnosa_utama LIKE ? OR " +
            "resume_pasien_ranap.prosedur_utama LIKE ? OR reg_periksa.no_rawat LIKE ? OR resume_pasien_ranap.kd_prosedur_utama LIKE ?) ") +
            "ORDER BY kamar_inap.tgl_keluar DESC, reg_periksa.status_lanjut");

        // Menyimpan tanggal untuk debug
        String startDate = Valid.SetTgl(DTPCari1.getSelectedItem() + "");
        String endDate = Valid.SetTgl(DTPCari2.getSelectedItem() + "");
//        System.out.println("Tanggal Mulai: " + startDate);
//        System.out.println("Tanggal Akhir: " + endDate);

        try {
            // Mengatur parameter untuk tgl_keluar
