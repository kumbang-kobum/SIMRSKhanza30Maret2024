...
public class DlgSOAPOld extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SOAP Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
                ...
                while(rs.next()){
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                ...
                                "pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,pemeriksaan_ralan.nip,pegawai.nama,departemen.nama "+
                                "from pemeriksaan_ralan inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where pemeriksaan_ralan.no_rawat='"+rs.getString("no_rawat")+"' "+
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.keluhan,"+
                                "pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.rtl,pemeriksaan_ranap.penilaian,pemeriksaan_ranap.instruksi,pemeriksaan_ranap.evaluasi,pemeriksaan_ranap.nip,pegawai.nama,departemen.nama, "+
                        ...
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Asesmen</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Plan</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Instruksi</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Evaluasi</td>"+
                                ...
                                //2021/04/18/000056
                                 htmlContent.append(                             
                                    "<tr class='isi'  >"+
                                        ...
                                        "<td align='left' "+stylee+">"+rs2.getString("evaluasi")+"</td>"+
                                         "<td align='left' "+stylee+">"+
                                            "<br>"+gbrverif+
                                            "<br>"+rs2.getString("namavalidator")+
                                            "<br>"+rs2.getString("tgl_validasi")+
                                            "<br>"+rs2.getString("jam_validasi")+
                                        "</td>"+
