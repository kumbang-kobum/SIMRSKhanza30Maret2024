                ...
                if(sisahutang>0){
                    ...
                    if(koderekening.equals("")){
                        ...
                        if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(NoBukti.getText(),"U","K080 BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());//tambah chan
                            }
        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from toko_bayar_pemesanan where tgl_bayar=? and no_faktur=? and "+
                ...
                if(koderekening.equals("")){
                    ...
                    if(sukses==true){
                        sukses=jur.simpanJurnal(NoBukti.getText(),"U","K081 BATAL BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());//tambah chan 
                    }  
                } 
            }else{
                sukses=false;
