        ...
        if(jawab==JOptionPane.YES_OPTION){
            ...
            try {
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","K053 PEMBAYARAN PASIEN RAWAT JALAN, DIPOSTING OLEH "+akses.getkode());//tambah chan
                }
        ...
        if(jawab==JOptionPane.YES_OPTION){
            try {
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","K054 PEMBATALAN PEMBAYARAN PASIEN RAWAT JALAN, DIPOSTING OLEH "+akses.getkode());//tambah chan
                }
