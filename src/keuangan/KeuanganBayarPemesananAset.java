                ...
                if(sisahutang>0){
                    ...
                    if(koderekening.equals("")){
                        ...
                        if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(NoBukti.getText(),"U","K074 BAYAR PELUNASAN BARANG ASET/INVENTARIS NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());//tambah chan
                            }
        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from bayar_pemesanan_inventaris where tgl_bayar=? and no_faktur=? and "+
                ...
                if(koderekening.equals("")){
                    ...
                    if(sukses==true){
                        sukses=jur.simpanJurnal(NoBukti.getText(),"U","K075 BATAL BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());//tambah chan 
                    }
                }
            }else{
                sukses=false;
    ...
    private void BtnSimpanMandiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanMandiriActionPerformed
        if(NoRekening.getText().trim().equals("")){
            ...
            try {
                ...
                if(sukses==true){
                sukses=jur.simpanJurnal(NoBukti.getText(),"U","K176 BAYAR PELUNASAN BARANG ASET/INVENTARIS NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());//tambah chan
                }
