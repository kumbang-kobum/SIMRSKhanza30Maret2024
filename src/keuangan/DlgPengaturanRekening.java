package keuangan;//GEN-FIRST:event_MnCopyRekeningActionPerformed
import fungsi.WarnaTable;//GEN-LAST:event_MnCopyRekeningActionPerformed
...
public class DlgPengaturanRekening extends javax.swing.JDialog {
    ...
    private void tbPengaturanKeyPressed(java.awt.event.KeyEvent evt) {                                        
    ...
    private void tbPengaturanRalanKeyPressed(java.awt.event.KeyEvent evt) {                                             
    ...
    private void tbPengaturanRanapKeyPressed(java.awt.event.KeyEvent evt) {                                             
    ...
    private void MnCopyRekeningActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void tbPengaturanRalanMouseClicked(java.awt.event.MouseEvent evt) {                                               
        if(tabModeRalan.getRowCount()!=0){
