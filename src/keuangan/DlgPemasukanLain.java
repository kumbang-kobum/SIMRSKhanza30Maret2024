...
public final class DlgPemasukanLain extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-02-2025 10:18:40" }));
                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(Nomor.getText(),"U","K070 PEMASUKAN LAIN-LAIN OLEH "+akses.getkode());
                            }
                        }
                    } catch (Exception e) {
                        sukses=false;
                    ...
                    try {
                        ...
                        try{
                            ...
                            if(rs.next()){
                                ...
                                if(sukses==true){
                                    sukses=jur.simpanJurnal(tbResep.getValueAt(tbResep.getSelectedRow(),0).toString(),"U","K071 PEMBATALAN PEMASUKAN LAIN-LAIN OLEH "+akses.getkode());
                                }
                            } 
                        } catch (Exception e) {
                            sukses=false;
