                ...
                if(sisahutang>0){
                    ...
                    if(koderekening.equals("")){
                        ...
                        if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                            ...
                            if(sukses==true){
                            sukses=jur.simpanJurnal(NoBukti.getText(),"U","K177 BAYAR PELUNASAN BARANG DAPUR NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());
                            }
        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from bayar_pemesanan_dapur where tgl_bayar=? and no_faktur=? and "+
                ...
                if(koderekening.equals("")){
                    ...
                    if(sukses==true){
                    sukses=jur.simpanJurnal(NoBukti.getText(),"U","K178 BATAL BAYAR PELUNASAN BARANG DAPUR NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode()); 
                }
                }
            }else{
                sukses=false;
    ...
    private void BtnSimpanMandiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanMandiriActionPerformed
        if(NoRekening.getText().trim().equals("")){
            ...
            try {
                ...
                if(sukses==true){
                sukses=jur.simpanJurnal(NoBukti.getText(),"U","K179 BAYAR PELUNASAN BARANG DAPUR NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());
                }
