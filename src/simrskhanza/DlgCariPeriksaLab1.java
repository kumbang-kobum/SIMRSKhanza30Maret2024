...
public class DlgCariPeriksaLab1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaLab1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaLab1 dialog = new DlgCariPeriksaLab1(new javax.swing.JFrame(), true);
