...
import bridging.ICareRiwayatPerawatan;//tambah chan
import rekammedis.RMRiwayatSOAPIECPPT;//tambah chan
import rekammedis.RMRiwayatPenunjang;//tambah chan
import rekammedis.RMRiwayatPengobatan;//tambah chan
...
import java.io.FileInputStream;//tambah chan
...
import java.util.Properties;//tambah chan
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",kode_poli="",kd_pj="",poli_ralan="No",cara_bayar_ralan="No",TANGGALMUNDUR="yes",
            ...
            Beban_Jasa_Menejemen_Tindakan_Ralan="",Utang_Jasa_Menejemen_Tindakan_Ralan="",poli="";//tambah chan
    ...
    private void initComponents() {
        ...
        BtnRiwayatSoapPpaMenu = new widget.Button();//tambah chan
        BtnBerkasDigitalMenu = new widget.Button();//tambah chan
        BtnHasilRadiologi = new widget.Button();//tambah chan
        BtnHasilPengobatan = new widget.Button();//tambah chan
        BtnResepObatMenu = new widget.Button();//tambah chan
        BtnHasilPengobatan1 = new widget.Button();//tambah chan
        BtnPermintaanLabMenu = new widget.Button();//tambah chan
        BtnPermintaanRadMenu = new widget.Button();//tambah chan
        BtnCopyResepMenu = new widget.Button();//tambah chan
        ...
        BtnPanggilPasien = new widget.Button();//tambah chan
        ...
        BtnPanggilPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/man1-24.png"))); //tambah chan
        BtnPanggilPasien.setMnemonic('P');
        BtnPanggilPasien.setText("Panggil Pasien");
        BtnPanggilPasien.setToolTipText("Alt+P");
        BtnPanggilPasien.setName("BtnPanggilPasien");
        BtnPanggilPasien.setPreferredSize(new java.awt.Dimension(10, 30));
        ...
        BtnPanggilPasien.setBounds(940, 10, 150, 30);
        ...
        //semua menu masuk sini rian sisi kiri
        
        BtnRiwayatMenu = new widget.Button();
        BtnRiwayatMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/1358372639_kmenuedit.png"))); // NOI18N
        BtnRiwayatMenu.setMnemonic('4');
        BtnRiwayatMenu.setText("Riwayat Perawatan");
        BtnRiwayatMenu.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        BtnRiwayatMenu.setBounds(910, 10, 160, 26);
        
        BtnCari2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/011.png"))); //tambah chan
        BtnCari2.setMnemonic('6');
        BtnCari2.setText("Ambil dari Awal Medis");
        BtnCari2.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnCari2.setToolTipText("Alt+6");
        BtnCari2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCari2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCari2.setName("BtnCari2");
        ...
        BtnCari2.setBounds(910, 40, 190, 26);
        
        BtnCari1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/011.png"))); //tambah chan
        BtnCari1.setMnemonic('6');
        BtnCari1.setText("Ambil dari Awal Kep");
        BtnCari1.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        BtnCari1.setBounds(910, 70, 170, 26);
        ...
        BtnIcare.setBounds(910, 100, 160, 26);
        
        BtnRiwayatSoapPpaMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatSoapPpaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnRiwayatSoapPpaMenu.setMnemonic('4');
        BtnRiwayatSoapPpaMenu.setText("Riwayat SOAP PPA");
        BtnRiwayatSoapPpaMenu.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRiwayatSoapPpaMenu.setToolTipText("");
        BtnRiwayatSoapPpaMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatSoapPpaMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatSoapPpaMenu.setName("BtnRiwayatSoapPpaMenu"); // NOI18N
        BtnRiwayatSoapPpaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatSoapPpaMenuActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRiwayatSoapPpaMenu);
        BtnRiwayatSoapPpaMenu.setBounds(910, 130, 160, 26);
        ...
        BtnHasilRadiologi.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        BtnHasilRadiologi.setBounds(910, 160, 160, 26);
        ...
        BtnHasilPengobatan.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        BtnHasilPengobatan.setBounds(910, 190, 160, 26);
        
        BtnResepObatMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnResepObatMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnResepObatMenu.setMnemonic('4');
        BtnResepObatMenu.setText("Input Resep Ralan");
        BtnResepObatMenu.setToolTipText("");
        BtnResepObatMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnResepObatMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnResepObatMenu.setName("BtnResepObatMenu"); // NOI18N
        BtnResepObatMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResepObatActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnResepObatMenu);
        BtnResepObatMenu.setBounds(910, 220, 160, 26);
        
        //semua menu masuk sini rian sisi kanan
        
        BtnBerkasDigitalMenu = new widget.Button();
        BtnBerkasDigitalMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnBerkasDigitalMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Create-Ticket24.png"))); // NOI18N
        BtnBerkasDigitalMenu.setMnemonic('4');
        BtnBerkasDigitalMenu.setText("Berkas Digital Pasien");
        ...
        BtnBerkasDigitalMenu.setBounds(1130, 10, 160, 26);
        ...
        BtnHasilPengobatan1.setBounds(1130, 40, 160, 26);

        BtnPermintaanLabMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPermintaanLabMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Bar Chart.png"))); // NOI18N
        BtnPermintaanLabMenu.setMnemonic('4');
        BtnPermintaanLabMenu.setText("Permintaan LAB");
        BtnPermintaanLabMenu.setToolTipText("");
        BtnPermintaanLabMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPermintaanLabMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPermintaanLabMenu.setName("BtnPermintaanLabMenu"); // NOI18N
        BtnPermintaanLabMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanLabActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPermintaanLabMenu);
        BtnPermintaanLabMenu.setBounds(1130, 70, 160, 26);
        
        BtnPermintaanRadMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPermintaanRadMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/barranap.png"))); // NOI18N
        BtnPermintaanRadMenu.setMnemonic('4');
        BtnPermintaanRadMenu.setText("Permintaan RAD");
        BtnPermintaanRadMenu.setToolTipText("");
        BtnPermintaanRadMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPermintaanRadMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPermintaanRadMenu.setName("BtnPermintaanRadMenu"); // NOI18N
        BtnPermintaanRadMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanRadActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPermintaanRadMenu);
        BtnPermintaanRadMenu.setBounds(1130, 100, 160, 26);
        
        BtnCopyResepMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnCopyResepMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Pills.png"))); // NOI18N
        BtnCopyResepMenu.setMnemonic('4');
        BtnCopyResepMenu.setText("Copy Resep Dokter");
        BtnCopyResepMenu.setToolTipText("");
        BtnCopyResepMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCopyResepMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCopyResepMenu.setName("BtnCopyResepMenu"); // NOI18N
        BtnCopyResepMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyResepActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCopyResepMenu);
        BtnCopyResepMenu.setBounds(1130, 130, 160, 26);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnPanggilPasienActionPerformed(java.awt.event.ActionEvent evt) {//tambah chan                                                 
    ...
    //tambah chan semua masuk sini rian
    private void BtnRiwayatSoapPpaMenuActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
...
//tambah chan akhir
    ...
    */
    ...
    private widget.Button BtnRiwayatSoapPpaMenu;//tambah chan
    private widget.Button BtnBerkasDigitalMenu;//tambah chan
    private widget.Button BtnHasilRadiologi;//tambah chan
    private widget.Button BtnHasilPengobatan;//tambah chan
    private widget.Button BtnResepObatMenu;//tambah chan
    private widget.Button BtnHasilPengobatan1;//tambah chan
    private widget.Button BtnPermintaanLabMenu;//tambah chan
    private widget.Button BtnPermintaanRadMenu;//tambah chan
    private widget.Button BtnCopyResepMenu;//tambah chan
    ...
    private widget.Button BtnPanggilPasien;//tambah chan
    ...
    private void SimpanPenangananDokterPetugas(){        
        try {
            ...
            if(sukses==true){
                ...
                if(sukses==true){
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","133 TINDAKAN RAWAT JALAN PASIEN "+TNoRM.getText()+" "+TPasien.getText()+", DIPOSTING OLEH "+akses.getkode());//tambah chan 
                }                                               
            }
