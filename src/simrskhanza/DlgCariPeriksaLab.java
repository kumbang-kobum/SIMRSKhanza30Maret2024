...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLab(java.awt.Frame parent, boolean modal) {
        ...
        tbDokter.setDefaultRenderer(Object.class, new WarnaTable());
            tabMode2=new DefaultTableModel(null,new Object[]{
                ...
                "Ruang","Petugas","Dokter Perujuk","Penanggung Jawab","No SEP"//tambah chan
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        for (i = 0; i < 15; i++) {//tambah chan
            ...
            if(i==0){
                ...
                column.setPreferredWidth(180);//tambah chan    
            }
        }
    ...
    private void initComponents() {
        ...
        MnKirimHasilLabPasien = new javax.swing.JMenuItem();
        ...
        MnKirimHasilLabPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKirimHasilLabPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKirimHasilLabPasien.setText("Kirim WA Pasien");
        MnKirimHasilLabPasien.setName("MnKirimHasilLabPasien"); // NOI18N
        MnKirimHasilLabPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKirimHasilLabPasienActionPerformed(evt);
            }
        });
        MnKirimWA.add(MnKirimHasilLabPasien);
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if(tabMode.getRowCount()==0){
                    ...
                    param.put("userid", akses.getkode());//tambah chan
                    param.put("ipaddress", akses.getalamatip());//tambah chan
            ...
            case 1:
                if(tabMode2.getRowCount()==0){
                    ...
                    Sequel.queryu("delete from temporary_lab where temp36 = '"+akses.getkode()+"' and temp37 = '"+akses.getalamatip()+"'");//tambah chan
                    ...
                    try{
                        ...
                        if(sukses==true){
                            if(status.equals("Ranap")){
                                ...
                                if(sukses==true){
                                    sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","K097 PEMBATALAN PEMERIKSAAN LABORAT RAWAT INAP PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+" OLEH "+akses.getkode());//tambah chan 
                                } 
                                ...
                                if(sukses==true){
                                    sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","K098 PEMBATALAN PEMERIKSAAN LABORAT RAWAT JALAN PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+" OLEH "+akses.getkode());//tambah chan 
                                } 
                            }
                        }
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
            ...
            try {   
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        param.put("lahir",rs.getString("lahir"));//tambah chan
                        ...
                        try {
                            ...
                            i=0;
                            while(rs2.next()){
                                Sequel.menyimpan("temporary_lab","'"+i+"','"+rs2.getString("nm_perawatan")+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Data User");//tambah chan 
                                i++;
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        Sequel.menyimpan("temporary_lab","'"+i+"','  "+rs3.getString("Pemeriksaan")+"','"+rs3.getString("nilai").replaceAll("'","`")+"','"+rs3.getString("satuan")
                                                +"','"+rs3.getString("nilai_rujukan")+"','"+rs3.getString("keterangan")+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Data User");//tambah chan 
                                        i++;
                                    }
                                } catch (Exception e) {
                    ...
                    if(rs.next()){
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                ttl=ttl+item;                    
                                Sequel.menyimpan("temporary_lab","'"+i+"','"+rs2.getString("kd_jenis_prw")+"','"+rs2.getString("nm_perawatan")+"','"+item+"','Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");//tambah chan                        
                                i++;
                                ps3=koneksi.prepareStatement(
                                    "select template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai,template_laboratorium.satuan,detail_periksa_lab.nilai_rujukan,detail_periksa_lab.biaya_item,"+
                                    "detail_periksa_lab.keterangan,detail_periksa_lab.kd_jenis_prw from detail_periksa_lab inner join template_laboratorium on detail_periksa_lab.id_template=template_laboratorium.id_template "+
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        ...
                                        ttl=ttl+item; 
                                        Sequel.menyimpan("temporary_lab","'"+i+"','"+rs3.getString("kd_jenis_prw")+"','   "+rs3.getString("Pemeriksaan")+"','"+item+"','Detail Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");//tambah chan                        
                                        i++;
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif ps3 : "+e);
                        ...
                        Sequel.menyimpan("temporary_lab","'"+i+"','','Total Biaya Pemeriksaan Lab','"+ttl+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");//tambah chan
                        i++;
    ...
    private void MnKirimHasilLabPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKirimHasilLabPasienActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    try {   
        ...
        while(rs.next()){
            // ==== PARAMETER LAPORAN (sama seperti cetak) ====
            ...
            // ==== ISI TEMPORARY: HEADER + DETAIL (sama seperti cetak) ====
            ps2=koneksi.prepareStatement(
            ...
            if(pspermintaan!=null) pspermintaan.close();
            ...
            String fileUrl = "https://waha.rsuhandayani.co.id/HasilLab/" + out.getName();
            ...
            String pesan  = "Halo Kaka " + rs.getString("nm_pasien") + ", berikut hasil lab Anda dari RSU Handayani:\n" + fileUrl;
        ...
        try{ if(ps4!=null) ps4.close(); }catch(Exception ex){}
        this.setCursor(Cursor.getDefaultCursor());
        System.out.println("[WAHA] Selesai.");
    }
    }//GEN-LAST:event_MnKirimHasilLabPasienActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnKirimHasilLabPasien;
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,bridging_sep.no_sep from periksa_lab inner join reg_periksa inner join pasien inner join penjab "+//tambah chan
                    ...
                    "and reg_periksa.kd_pj=penjab.kd_pj LEFT JOIN bridging_sep ON periksa_lab.no_rawat = bridging_sep.no_rawat where periksa_lab.kategori='PK' and periksa_lab.tgl_periksa between ? and ? order by periksa_lab.tgl_periksa desc,periksa_lab.jam desc,detail_periksa_lab.kd_jenis_prw,template_laboratorium.urut");//tambah chan  
            }else{
                ps=koneksi.prepareStatement(
                    "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,petugas.nama,periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.status,"+
                    "periksa_lab.dokter_perujuk,periksa_lab.kd_dokter,dokter.nm_dokter,template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai,penjab.png_jawab,"+
                    ...
                    "periksa_lab.no_rawat=detail_periksa_lab.no_rawat and periksa_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw and periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw and "+
                    "periksa_lab.tgl_periksa=detail_periksa_lab.tgl_periksa and periksa_lab.jam=detail_periksa_lab.jam and periksa_lab.nip=petugas.nip and reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "and reg_periksa.kd_pj=penjab.kd_pj LEFT JOIN bridging_sep ON periksa_lab.no_rawat = bridging_sep.no_rawat where periksa_lab.kategori='PK' and periksa_lab.tgl_periksa between ? and ? and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and "+//tambah chan
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode2.addRow(new Object[]{
                        ...
                        rs.getString("nm_dokter"),rs.getString("no_sep")//tambah chan                        
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif ps : "+e);
