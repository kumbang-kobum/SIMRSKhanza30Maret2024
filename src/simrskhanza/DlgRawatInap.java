...
import rekammedis.DlgSOAPOld;//tambah chan
import rekammedis.RMRiwayatOperasi;//tambah chan
import rekammedis.RMRiwayatPenunjang;//tambah chan
import rekammedis.ValidasiSOAP;//tambah chan
import widget.Button;//tambah chan
import widget.ComboBox;//tambah chan
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private RMCari5SOAPTerakhir soapterakhir=new RMCari5SOAPTerakhir(null,false);//tambah chan  
    ...
    private ComboBox cmbOksigenasi;//tambah chan
    private Button BtnDokter3;//tambah chan
    private Button BtnDokter2;//tambah chan
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Inst/Impl","Evaluasi","Oksigenasi","Sekala Nyeri","NIP","Dokter/Paramedis","Profesi/Jabatan"}){ //tambah chan
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
             ...
             Class[] types = new Class[] {
                 ...
                 java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, 
                 java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, 
                 java.lang.Object.class, java.lang.Object.class, java.lang.Object.class,//tambah chan 2
             };
             @Override
             public Class getColumnClass(int columnIndex) {
                return types [columnIndex];
    ...
    private void initComponents() {
        ...
        jLabel611 = new widget.Label();//tambah chan
        TSNyeri = new widget.TextBox();//tambah chan
        jLabel411 = new widget.Label();//tambah chan
        ...
        BtnDataSoap = new widget.Button();//tambah chan
        BtnVerifSoap = new widget.Button();//tambah chan
        Btn5Soap1 = new widget.Button();//tambah chan
        BtnHasilRadiologi = new widget.Button();//tambah chan
        BtnHasilPengobatan1 = new widget.Button();//tambah chan
        BtnBerkasDigitalMenu = new widget.Button();//tambah chan
        BtnIcare = new widget.Button();//tambah chan
        BtnInputResume = new widget.Button();//tambah chan
        BtnPemantauanPEWSAnakMenu = new widget.Button();//tambah chan
        BtnPemantauanPEWSDewasaMenu = new widget.Button();//tambah chan
        BtnCatatanCekGDSMenu = new widget.Button();//tambah chan
        BtnCatatanObservasiRanapMenu = new widget.Button();//tambah chan
        BtnCatatanObservasiRanapKebidananMenu = new widget.Button();//tambah chan
        BtnPenilaianLanjutanResikoJatuhAnakMenu = new widget.Button();//tambah chan
        BtnPenilaianLanjutanResikoJatuhDewasaMenu = new widget.Button();//tambah chan
        BtnPenilaianLanjutanResikoJatuhLansiaMenu = new widget.Button();//tambah chan
        BtnMonitoringReaksiTranfusiMenu = new widget.Button();//tambah chan
        BtnRiwayatMenu = new widget.Button();//tambah chan
        ...
        jLabel611.setText("Oksigenasi :");//tambah chan
        jLabel611.setName("jLabel611"); // NOI18N//tambah chan
        panelGlass12.add(jLabel611);
        jLabel611.setBounds(130, 250, 70, 23);//tambah chan
        ...
        jLabel411.setText("Sekala Nyeri :");//tambah chan
        jLabel411.setName("jLabel411"); // NOI18N//tambah chan
        panelGlass12.add(jLabel411);//tambah chan
        jLabel411.setBounds(0, 250, 70, 23);//tambah chan

        // Tambah menu sebelah kiri       
        // Tombol untuk Data Verif SOAP tambah chan
        BtnRiwayatMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/63.png"))); // NOI18N
        BtnRiwayatMenu.setMnemonic('4');
        BtnRiwayatMenu.setText("Riwayat Perawatan");
        BtnRiwayatMenu.setToolTipText("");
        BtnRiwayatMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatMenu.setName("BtnRiwayatMenu"); // NOI18N
        BtnRiwayatMenu.setPreferredSize(new java.awt.Dimension(150, 33));
        BtnRiwayatMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRiwayatMenu);
        BtnRiwayatMenu.setBounds(910, 10, 180, 30);
        
        BtnDataSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/85.png"))); // Ikon Data Verif SOAP
        BtnDataSoap.setMnemonic('3');
        BtnDataSoap.setText("Data Verif SOAP");
        BtnDataSoap.setToolTipText("Alt+3");
        BtnDataSoap.setName("BtnDataSoap");
        BtnDataSoap.setPreferredSize(new java.awt.Dimension(150, 30)); // Ukuran tombol disesuaikan
        BtnDataSoap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDataSoap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataSoap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDataSoapActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataSoap);
        BtnDataSoap.setBounds(910, 40, 180, 30); // batas tambah chan

        // Tombol untuk Validasi SOAP tambah chan
        BtnVerifSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // Ikon Validasi SOAP
        BtnVerifSoap.setMnemonic('4');
        BtnVerifSoap.setText("Validasi SOAP");
        BtnVerifSoap.setToolTipText("Alt+4");
        BtnVerifSoap.setName("BtnVerifSoap");
        BtnVerifSoap.setPreferredSize(new java.awt.Dimension(150, 30)); // Ukuran tombol disesuaikan
        BtnVerifSoap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifSoap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnVerifSoap.setBounds(910, 70, 150, 30);
        ...
        BtnHasilRadiologi.setPreferredSize(new java.awt.Dimension(119, 33));
        ...
        BtnHasilRadiologi.setBounds(910, 100, 190, 30);
        ...
        BtnHasilPengobatan1.setPreferredSize(new java.awt.Dimension(119, 33));
        ...
        BtnHasilPengobatan1.setBounds(910, 130, 190, 30);
        
        BtnBerkasDigitalMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnBerkasDigitalMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-16x16.png"))); // NOI18N
        BtnBerkasDigitalMenu.setMnemonic('4');
        BtnBerkasDigitalMenu.setText("Berkas Digital Keperawatan");
        BtnBerkasDigitalMenu.setToolTipText("");
        BtnBerkasDigitalMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnBerkasDigitalMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBerkasDigitalMenu.setName("BtnBerkasDigitalMenu"); // NOI18N
        BtnBerkasDigitalMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBerkasDigitalActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBerkasDigitalMenu);
        BtnBerkasDigitalMenu.setBounds(910, 170, 190, 30);
        
        BtnIcare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/SWF24.png"))); //tambah chan
        BtnIcare.setMnemonic('2');
        BtnIcare.setText("History Icare");
        BtnIcare.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnIcare.setToolTipText("Alt+2");
        BtnIcare.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnIcare.setBounds(910, 200, 160, 26);
        ...
        BtnInputResume.setBounds(910, 230, 190, 30);
        
        BtnPemantauanPEWSAnakMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPemantauanPEWSAnakMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFemale.png"))); // NOI18N
        BtnPemantauanPEWSAnakMenu.setMnemonic('4');
        BtnPemantauanPEWSAnakMenu.setText("EWS Anak");
        BtnPemantauanPEWSAnakMenu.setToolTipText("");
        BtnPemantauanPEWSAnakMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPemantauanPEWSAnakMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemantauanPEWSAnakMenu.setName("BtnPemantauanPEWSAnakMenu"); // NOI18N
        BtnPemantauanPEWSAnakMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnPemantauanPEWSAnakMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemantauanPEWSAnakActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPemantauanPEWSAnakMenu);
        BtnPemantauanPEWSAnakMenu.setBounds(910, 270, 190, 30);
        
        //Tambah menu sebelah kanan
        
        BtnPemantauanPEWSDewasaMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPemantauanPEWSDewasaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/female-user-help24.png"))); // NOI18N
        BtnPemantauanPEWSDewasaMenu.setMnemonic('4');
        BtnPemantauanPEWSDewasaMenu.setText("EWS Dewasa");
        BtnPemantauanPEWSDewasaMenu.setToolTipText("");
        BtnPemantauanPEWSDewasaMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPemantauanPEWSDewasaMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemantauanPEWSDewasaMenu.setName("BtnPemantauanPEWSDewasaMenu"); // NOI18N
        BtnPemantauanPEWSDewasaMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnPemantauanPEWSDewasaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemantauanPEWSDewasaActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPemantauanPEWSDewasaMenu);
        BtnPemantauanPEWSDewasaMenu.setBounds(1130, 10, 190, 30);
        
        
        BtnCatatanCekGDSMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnCatatanCekGDSMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Syringe.png"))); // NOI18N
        BtnCatatanCekGDSMenu.setMnemonic('4');
        BtnCatatanCekGDSMenu.setText("Catatan cek GDS");
        BtnCatatanCekGDSMenu.setToolTipText("");
        BtnCatatanCekGDSMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCatatanCekGDSMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCatatanCekGDSMenu.setName("BtnCatatanCekGDSMenu"); // NOI18N
        BtnCatatanCekGDSMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnCatatanCekGDSMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanCekGDSActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCatatanCekGDSMenu);
        BtnCatatanCekGDSMenu.setBounds(1130, 40, 190, 30);
        
        BtnCatatanObservasiRanapMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnCatatanObservasiRanapMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Garden.png"))); // NOI18N
        BtnCatatanObservasiRanapMenu.setMnemonic('4');
        BtnCatatanObservasiRanapMenu.setText("Observasi Ranap");
        BtnCatatanObservasiRanapMenu.setToolTipText("");
        BtnCatatanObservasiRanapMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCatatanObservasiRanapMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCatatanObservasiRanapMenu.setName("BtnCatatanObservasiRanapMenu"); // NOI18N
        BtnCatatanObservasiRanapMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnCatatanObservasiRanapMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanObservasiRanapActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCatatanObservasiRanapMenu);
        BtnCatatanObservasiRanapMenu.setBounds(1130, 70, 190, 30);
        
        BtnCatatanObservasiRanapKebidananMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnCatatanObservasiRanapKebidananMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/female-user-info24.png"))); // NOI18N
        BtnCatatanObservasiRanapKebidananMenu.setMnemonic('4');
        BtnCatatanObservasiRanapKebidananMenu.setText("Observasi Kebidanan");
        BtnCatatanObservasiRanapKebidananMenu.setToolTipText("");
        BtnCatatanObservasiRanapKebidananMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCatatanObservasiRanapKebidananMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCatatanObservasiRanapKebidananMenu.setName("BtnCatatanObservasiRanapKebidananMenu"); // NOI18N
        BtnCatatanObservasiRanapKebidananMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnCatatanObservasiRanapKebidananMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanObservasiRanapKebidananActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCatatanObservasiRanapKebidananMenu);
        BtnCatatanObservasiRanapKebidananMenu.setBounds(1130, 100, 190, 30);
        
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/man-24.png"))); // NOI18N
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setMnemonic('4');
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setText("R Jatuh Anak");
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setToolTipText("");
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setName("BtnPenilaianLanjutanResikoJatuhAnakMenu"); // NOI18N
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnPenilaianLanjutanResikoJatuhAnakMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianLanjutanResikoJatuhAnakActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPenilaianLanjutanResikoJatuhAnakMenu);
        BtnPenilaianLanjutanResikoJatuhAnakMenu.setBounds(1130, 130, 190, 30);
        
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/man1-24.png"))); // NOI18N
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setMnemonic('4');
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setText("R Jatuh Dewasa");
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setToolTipText("");
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setName("BtnPenilaianLanjutanResikoJatuhDewasaMenu"); // NOI18N
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianLanjutanResikoJatuhDewasaActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPenilaianLanjutanResikoJatuhDewasaMenu);
        BtnPenilaianLanjutanResikoJatuhDewasaMenu.setBounds(1130, 160, 190, 30);
        
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientMale.png"))); // NOI18N
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setMnemonic('4');
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setText("R Jatuh Lansia");
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setToolTipText("");
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setName("BtnPenilaianLanjutanResikoJatuhLansiaMenu"); // NOI18N
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianLanjutanResikoJatuhLansiaActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPenilaianLanjutanResikoJatuhLansiaMenu);
        BtnPenilaianLanjutanResikoJatuhLansiaMenu.setBounds(1130, 190, 190, 30);
        
        BtnMonitoringReaksiTranfusiMenu.setForeground(new java.awt.Color(0, 0, 0));
        BtnMonitoringReaksiTranfusiMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/DefinedParameters.png"))); // NOI18N
        BtnMonitoringReaksiTranfusiMenu.setMnemonic('4');
        BtnMonitoringReaksiTranfusiMenu.setText("Monitoring Transfusi");
        BtnMonitoringReaksiTranfusiMenu.setToolTipText("");
        BtnMonitoringReaksiTranfusiMenu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnMonitoringReaksiTranfusiMenu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnMonitoringReaksiTranfusiMenu.setName("BtnMonitoringReaksiTranfusiMenu"); // NOI18N
        BtnMonitoringReaksiTranfusiMenu.setPreferredSize(new java.awt.Dimension(119, 33));
        BtnMonitoringReaksiTranfusiMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMonitoringReaksiTranfusiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnMonitoringReaksiTranfusiMenu);
        BtnMonitoringReaksiTranfusiMenu.setBounds(1130, 220, 190, 30);
        
        // batas tambah chan menu
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void cmbOksigenasiKeyPressed(java.awt.event.KeyEvent evt) {                                         
    ...
    //tambahan menu sisi kiri kanan
    private void BtnDataSoapActionPerformed(java.awt.event.ActionEvent evt) { //tambah chan                                           
        // TODO add your handling code here:
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        ...
        private void BtnVerifSoapActionPerformed(java.awt.event.ActionEvent evt) { //tambah chan                                            
        // TODO add your handling code here:
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    }    // akhir tambahan sisi menu kiri kanan 
    ...
    */
    ...
    private widget.Button BtnDataSoap;//tambah chan
    private widget.Button BtnVerifSoap;//tambah chan
    private widget.Button Btn5Soap1;//tambah chan
    private widget.Button BtnHasilRadiologi;//tambah chan
    private widget.Button BtnHasilPengobatan1;//tambah chan
    private widget.Button BtnBerkasDigitalMenu;//tambah chan
    private widget.Button BtnIcare;//tambah chan
    private widget.Button BtnInputResume;//tambah chan
    private widget.Button BtnPemantauanPEWSAnakMenu;//tambah chan
    private widget.Button BtnPemantauanPEWSDewasaMenu;//tambah chan
    private widget.Button BtnCatatanCekGDSMenu;//tambah chan
    private widget.Button BtnCatatanObservasiRanapMenu;//tambah chan
    private widget.Button BtnCatatanObservasiRanapKebidananMenu;//tambah chan
    private widget.Button BtnPenilaianLanjutanResikoJatuhAnakMenu;//tambah chan
    private widget.Button BtnPenilaianLanjutanResikoJatuhDewasaMenu;//tambah chan
    private widget.Button BtnPenilaianLanjutanResikoJatuhLansiaMenu;//tambah chan
    private widget.Button BtnMonitoringReaksiTranfusiMenu;//tambah chan
    private widget.Button BtnRiwayatMenu;//tambah chan
    ...
    private widget.Label jLabel411;
    ...
    private widget.Label jLabel611;//tambah chan
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput1.setPreferredSize(new Dimension(WIDTH,370)); //tambah chan
                ...
                if(KdDok.getText().trim().equals("")||TDokter.getText().trim().equals("")){
                    ...
                    if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                        ...
                        if(Sequel.menyimpantf("rawat_inap_dr","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(TNoRw.getText(),"U","K181 TINDAKAN RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());//tambah chan
                            }
                        }else{
                            sukses=false;
                        }
                ...
                if(kdptg.getText().trim().equals("")||TPerawat.getText().trim().equals("")){                              
                    ...
                    if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                        ...
                        if(Sequel.menyimpantf("rawat_inap_pr","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(TNoRw.getText(),"U","K182 TINDAKAN RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());//tambah chan 
                            }
                        }else{
                            sukses=false;
                        }
                ...
                if(KdDok2.getText().trim().equals("")||TDokter2.getText().trim().equals("")){                              
                    ...
                    if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                        ...
                        if(Sequel.menyimpantf("rawat_inap_drpr","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(TNoRw.getText(),"U","K183 TINDAKAN RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());//tambah chan
                            }
                        }else{
                            sukses=false;
                        }
