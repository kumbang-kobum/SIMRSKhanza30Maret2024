...
public final class SuratPersetujuanUmum extends javax.swing.JDialog {
    ...
    public SuratPersetujuanUmum(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Persetujuan","No.Rawat","No.R.M.","Nama Pasien","Umur","J.K.","Tgl.Lahir","Tanggal","Pengobatan Kepada","Nilai Kepercayaan","Nama Kecuali",//tambah chan
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_persetujuan_umum","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{//tambah chan
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),"-","","",NamaPJ.getText(),UmurPJ.getText(),NoKTP.getText(),//tambah chan
                ...
                tabMode.addRow(new Object[]{
                    ...
                    Valid.SetTgl(Tanggal.getSelectedItem()+""),"-","","",NamaPJ.getText(),UmurPJ.getText(),NoKTP.getText(),JKPJ.getSelectedItem().toString().substring(0,1),//tambah chan
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(NIP.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString())){//tambah chan
                    hapus();
                }else{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataPersetujuanUmum.jasper","report","::[ Data Persetujuan Umum ]::",
                    ...
                    "surat_persetujuan_umum.nilai_kepercayaan,surat_persetujuan_umum.nm_kecuali,surat_persetujuan_umum.nama_pj,surat_persetujuan_umum.umur_pj,surat_persetujuan_umum.no_ktppj,"+//tambah chan
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
		    ...
		    "surat_persetujuan_umum.nilai_kepercayaan,surat_persetujuan_umum.nm_kecuali,surat_persetujuan_umum.nama_pj,surat_persetujuan_umum.umur_pj,surat_persetujuan_umum.no_ktppj,surat_persetujuan_umum.jkpj,surat_persetujuan_umum.bertindak_atas,surat_persetujuan_umum.no_telp,surat_persetujuan_umum.nip,petugas.nama,penjab.png_jawab from surat_persetujuan_umum inner join reg_periksa on surat_persetujuan_umum.no_rawat=reg_periksa.no_rawat "+//tambah chan
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tanggal"),rs.getString("pengobatan_kepada"),rs.getString("nilai_kepercayaan"),rs.getString("nm_kecuali"),rs.getString("nama_pj"),//tambah chan
    ...
    private void getData() {
         if(tbObat.getSelectedRow()!= -1){
            ...
            NamaPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());//tambah chan 
            UmurPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());//tambah chan  
            NoKTP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());//tambah chan 
            JKPJ.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString().replaceAll("L","Laki-laki").replaceAll("P","Perempuan"));//tambah chan 
            NoTelp.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());//tambah chan 
            BertindakAtas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());//tambah chan  
    ...
    private void ganti() {
        if(Sequel.mengedittf("surat_persetujuan_umum","no_surat=?","no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,umur_pj=?,no_ktppj=?,jkpj=?,bertindak_atas=?,no_telp=?,nip=?",11,new String[]{
            ...
            tbObat.setValueAt(NamaPJ.getText(),tbObat.getSelectedRow(),11);//tambah chan 
            tbObat.setValueAt(UmurPJ.getText(),tbObat.getSelectedRow(),12);//tambah chan 
            tbObat.setValueAt(NoKTP.getText(),tbObat.getSelectedRow(),13);//tambah chan 
            tbObat.setValueAt(JKPJ.getSelectedItem().toString().substring(0,1),tbObat.getSelectedRow(),14);//tambah chan 
            tbObat.setValueAt(NoTelp.getText(),tbObat.getSelectedRow(),15);//tambah chan 
            tbObat.setValueAt(BertindakAtas.getSelectedItem().toString(),tbObat.getSelectedRow(),16);//tambah chan 
            tbObat.setValueAt(NIP.getText(),tbObat.getSelectedRow(),17);//tambah chan 
            tbObat.setValueAt(NamaPetugas.getText(),tbObat.getSelectedRow(),18);//tambah chan 
            emptTeks();
        }
    }
