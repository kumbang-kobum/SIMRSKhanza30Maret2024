...
import inventory.DlgCopyResep;//tambah chan
...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private String bangsal="",aktifkanparsial="no",kamar="",alarm="",DEPOAKTIFOBAT="",rincianobat="",
            ...
            NoRawat="",NoRM="",Pasien="",DokterPeresep="",Status="",KodeDokter="",Ruang="",KodeRuang="",KodePJ="";//tambah chan
    ...
    private void initComponents() {
        ...
        BtnAllResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAllResep.setText("All Resep");
        BtnAllResep.setFocusPainted(false);
        BtnAllResep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAllResep.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAllResep.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAllResep.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAllResep.setName("BtnAllResep"); // NOI18N
        BtnAllResep.setPreferredSize(new java.awt.Dimension(135, 23));
        BtnAllResep.setRoundRect(false);
        BtnAllResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAllResepActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAllResep);
...
*/
    ...
    private void BtnAllResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllResepActionPerformed
    if(TabPilihRawat.getSelectedIndex()==0){ //tambah chan Tab untuk Rawat Jalan
        if(TabRawatJalan.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
                TCari.requestFocus();
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgCopyResep copyResep = new DlgCopyResep(null, false); // Membuka dialog DlgCopyResep
                copyResep.isCek();
                copyResep.setRM(NoRawat, NoRM, KodeDokter, KodePJ, Status);
                copyResep.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
                copyResep.setLocationRelativeTo(internalFrame1);
                copyResep.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        } else if(TabRawatJalan.getSelectedIndex()==1){
            JOptionPane.showMessageDialog(null,"Maaf, silahkan buka Daftar Resep...!!!!");
    ...
    } else if(TabPilihRawat.getSelectedIndex()==1){ // Tab untuk Rawat Inap
        if(TabRawatInap.getSelectedIndex()==0){
            if(tabMode3.getRowCount()==0){
                JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
                TCari.requestFocus();
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgCopyResep copyResep = new DlgCopyResep(null, false); // Membuka dialog DlgCopyResep untuk Rawat Inap
                copyResep.isCek();
                copyResep.setRM(NoRawat, NoRM, KodeDokter, KodePJ, Status);
                copyResep.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
                copyResep.setLocationRelativeTo(internalFrame1);
            ...
            if(tabMode5.getRowCount()==0){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgCopyResep copyResep = new DlgCopyResep(null, false); // Membuka dialog DlgCopyResep di tab ini
                copyResep.isCek();
                copyResep.setRM(NoRawat, NoRM, KodeDokter, KodePJ, Status);
                copyResep.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
                copyResep.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_BtnAllResepActionPerformed
    ...
    */
    ...
    private widget.Button BtnAllResep;
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                        ...
                        " inner join kamar on kamar_inap.kd_kamar=kamar.kd_kamar "+
                        " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                        " where kamar_inap.stts_pulang NOT IN ('Meninggal') and permintaan_resep_pulang.tgl_permintaan between ? and ? "+//tambah chan
                        (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                ...
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                        ...
                        " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                        " inner join set_depo_ranap on set_depo_ranap.kd_bangsal=bangsal.kd_bangsal "+
                        " where set_depo_ranap.kd_depo='"+DEPOAKTIFOBAT+"' and kamar_inap.stts_pulang NOT IN ('Meninggal') and permintaan_resep_pulang.tgl_permintaan between ? and ? "+//tambah chan
                        (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                        "(permintaan_resep_pulang.no_permintaan like ? or permintaan_resep_pulang.no_rawat like ? or "+
                                    "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penjab.png_jawab like ?)")+
                        " group by permintaan_resep_pulang.no_permintaan order by permintaan_resep_pulang.tgl_permintaan desc,permintaan_resep_pulang.jam desc");
        ...
        ActionListener taskPerformer = (ActionEvent e) -> {
            if(aktif==true){
                ...
                if(detik.equals("05")){
                    ...
                    if(resepbaru>0){
                        try {
                            music = new BackgroundMusic("./suara/resepbaru.mp3");//tambah chan
                            music.start();
                        } catch (Exception ex) {
