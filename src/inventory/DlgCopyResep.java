...
public class DlgCopyResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnTampilAll = new widget.Button();
        ...
        BtnTampilAll.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Doctor.png"))); // NOI18N
        BtnTampilAll.setMnemonic('S');
        BtnTampilAll.setText("All Dokter");
        BtnTampilAll.setToolTipText("Alt+S");
        BtnTampilAll.setName("BtnTampilAll"); // NOI18N
        BtnTampilAll.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnTampilAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTampilAllActionPerformed(evt);
            }
        });
        BtnTampilAll.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnTampilAllKeyPressed(evt);
            }
        });
        panelisi1.add(BtnTampilAll);
...
*/
 ...
 tampil2();        // tambah chan
    ...
    private void BtnTampilAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTampilAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            tampil2();
        }else{
            Valid.pindah(evt, DTPCari1,BtnKeluar);
        }        // tambah chan
    }//GEN-LAST:event_BtnTampilAllKeyPressed
    ...
    */
    ...
    private widget.Button BtnTampilAll;
...
public void tampil2() { //tambah chan
    Valid.tabelKosong(tabMode);
    try {
        // Mendapatkan tanggal 4 bulan terakhir
        String tanggalEmpatBulanTerakhir = "DATE_SUB(CURDATE(), INTERVAL 4 MONTH)";

        // Query untuk menampilkan semua resep obat dari semua dokter untuk pasien tertentu
        if (ChkTanggal.isSelected()) {
            ps = koneksi.prepareStatement("SELECT resep_obat.no_resep, resep_obat.tgl_peresepan, resep_obat.jam_peresepan," +
                ...
                " AND resep_obat.tgl_peresepan >= " + tanggalEmpatBulanTerakhir + " " +
            ...
            ps = koneksi.prepareStatement("SELECT resep_obat.no_resep, resep_obat.tgl_peresepan, resep_obat.jam_peresepan," +
                ...
                " INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                " INNER JOIN dokter ON resep_obat.kd_dokter = dokter.kd_dokter " +
                " WHERE resep_obat.tgl_peresepan >= " + tanggalEmpatBulanTerakhir + " " +
                " AND pasien.no_rkm_medis = ? " +
                " ORDER BY resep_obat.tgl_perawatan, resep_obat.jam DESC");
        }
        ...
        try {
            ...
            // Pengecekan apakah ResultSet kosong
            if (!rs.isBeforeFirst()) {
                System.out.println("Tidak ada data untuk pasien ini.");
                return;
            }
            ...
            while (rs.next()) {
                tabMode.addRow(new Object[]{
                    ...
                    rs.getString("no_rawat") + " | " + rs.getString("nm_dokter"),
                ...
                tabMode.addRow(new Object[]{
                    "", "Jumlah", "Satuan", "Aturan Pakai", "Kode/No", "Nama Obat/Racikan", "", "", 
                    rs.getString("status_asal").replaceAll("ralan", "Rawat Jalan").replaceAll("ranap", "Rawat Inap")
                });

                // Sub-query untuk mengambil detail resep dokter
                ps2 = koneksi.prepareStatement("SELECT databarang.kode_brng, databarang.nama_brng, resep_dokter.jml," +
                ...
                try {
                    ...
                    if (!rs2.isBeforeFirst()) {
                        System.out.println("Tidak ada obat untuk resep no " + rs.getString("no_resep"));
                    }

                    while (rs2.next()) {
                        tabMode.addRow(new Object[]{
                            "", rs2.getString("jml"), rs2.getString("kode_sat"), rs2.getString("aturan_pakai"), 
                ...
                // Pisahkan dengan baris kosong atau pemisah
                tabMode.addRow(new Object[]{"", "", "", "----- Resep Pulang -----", "", "", "", "", ""});

                // Sub-query untuk mengambil resep pulang
                ps2 = koneksi.prepareStatement("SELECT resep_pulang.no_rawat, databarang.kode_brng, databarang.nama_brng, " +
                    " resep_pulang.jml_barang, resep_pulang.kd_bangsal, resep_pulang.tanggal, resep_pulang.jam " +
                    " FROM resep_pulang " +
                ...
                try {
                    ...
                    if (!rs2.isBeforeFirst()) {
                        System.out.println("Tidak ada resep pulang untuk rawat no " + rs.getString("no_rawat"));
                    }

                    while (rs2.next()) {
                        tabMode.addRow(new Object[]{
                            "", rs2.getString("jml_barang"), "", "", rs2.getString("kode_brng"), 
                            rs2.getString("nama_brng"), rs2.getString("tanggal"), rs2.getString("jam"), 
                            "Resep Pulang"
                        });
                    }
                } catch (Exception e) {
                ...
                // Pisahkan setiap resep dengan baris kosong
                tabMode.addRow(new Object[]{"", "", "", "", "", "", "", "", ""});
            }
        } catch (Exception ex) {
            System.out.println("Notifikasi : " + ex);
