        ...
        if(nmdari.getText().trim().equals("")||kddari.getText().trim().equals("")){
            ...
            if (i == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    if(sukses==true){
                        sukses=jur.simpanJurnal(Valid.SetTgl(Tanggal.getSelectedItem()+"").replaceAll("-","/"),"U","K028 PENGAMBILAN BHP MEDIS UTD DARI "+nmdari.getText().toUpperCase()+", OLEH "+akses.getkode());//tambah chan
                    }
                }
