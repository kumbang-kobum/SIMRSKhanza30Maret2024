                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            if(sukses==true){
                                ...
                                if(sukses==true){
                                    sukses=jur.simpanJurnal(rs.getString("no_faktur"),"U","K035 BATAL TRANSAKSI PENERIMAAN BARANG DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?",rs.getString("kd_bangsal")).toUpperCase()+", OLEH "+akses.getkode());//tambah chan
                                }
                            }
                                ...
                                if(Sequel.queryu2tf("delete from pemesanan where no_faktur=?",1,new String[]{NoFaktur2.getText()})==true){
                                    if(Sequel.menyimpantf2("pemesanan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Faktur",15,new String[]{
                                        ...
                                        if(sukses==true){
                                            ...
                                            if(sukses==true){
                                                sukses=jur.simpanJurnal(NoFaktur.getText(),"U","K036 PENERIMAAN BARANG DI "+nmgudang.getText().toUpperCase()+", OLEH "+akses.getkode());//tambah chan
                                            }   
                                        }
                                    }else{
                                        sukses=false;
