    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(sukses==true){
                ...
                if(sukses==true){
                    sukses=jur.simpanJurnal(DTPCari1.getSelectedItem().toString(),"U","K015 PEMBATALAN PENGAMBILAN BHP MEDIS UTD DARI "+tbKamar.getValueAt(tbKamar.getSelectedRow(),5)+", OLEH "+akses.getkode());//tambah chan
                }
            }
