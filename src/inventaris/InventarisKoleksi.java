...
public final class InventarisKoleksi extends javax.swing.JDialog {
    ...
    public InventarisKoleksi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Inventaris","Kode Barang","Nama Barang","Produsen",
                      ...
                      "No.Rak","No.Box","Tgl Kalibrasi","Tgl Expired","Status Expired"//tambah chan 2
        };
        ...
        for (int i = 0; i < 19; i++) {//tambah chan 2
            ...
            if(i==0){
                ...
                column.setPreferredWidth(200);//tambah chan 3    
            }
        }
    ...
    private void initComponents() {
        ...
        tgl_expired = new widget.Tanggal();
        label10 = new widget.Label();
        tgl_kalibrasi = new widget.Tanggal();
        ...
        tgl_pengadaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-04-2025" }));
        ...
        tgl_pengadaan.setBounds(300, 10, 100, 23);
        ...
        jPanel1.setBounds(420, 65, 340, 90);

        tgl_expired.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-04-2025" }));
        tgl_expired.setDisplayFormat("dd-MM-yyyy");
        tgl_expired.setName("tgl_expired"); // NOI18N
        tgl_expired.setOpaque(false);
        tgl_expired.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tgl_expiredKeyPressed(evt);
            }
        });
        FormInput.add(tgl_expired);
        tgl_expired.setBounds(640, 10, 100, 23);

        label10.setText("Tgl.Expired:");
        label10.setName("label10"); // NOI18N
        FormInput.add(label10);
        label10.setBounds(580, 10, 60, 23);

        tgl_kalibrasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-04-2025" }));
        tgl_kalibrasi.setDisplayFormat("dd-MM-yyyy");
        tgl_kalibrasi.setName("tgl_kalibrasi"); // NOI18N
        tgl_kalibrasi.setOpaque(false);
        tgl_kalibrasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tgl_kalibrasiKeyPressed(evt);
            }
        });
        FormInput.add(tgl_kalibrasi);
        tgl_kalibrasi.setBounds(470, 10, 100, 23);

        label11.setText("Tgl.Kalibrasi:");
        label11.setName("label11"); // NOI18N
        FormInput.add(label11);
        label11.setBounds(400, 10, 70, 23);
        ...
        status_barang.setBounds(790, 10, 60, 23);

        jLabel18.setText("Status :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(730, 10, 60, 23);
        ...
        if(no_inventaris.getText().trim().equals("")){
            ...
            Valid.textKosong(id_ruang,"Ruangan");
                ...
                Sequel.menyimpan("inventaris","'"+no_inventaris.getText()+"','"+kode_barang.getText()+"','"+asal_barang.getSelectedItem()+"','"+Valid.SetTgl(tgl_pengadaan.getSelectedItem()+"',")+
                        "','"+harga.getText()+"','"+status_barang.getSelectedItem()+"','"+id_ruang.getText()+"','"+no_rak.getSelectedItem()+"','"+no_box.getSelectedItem() + "','" +Valid.SetTgl(tgl_kalibrasi.getSelectedItem().toString()) + "','" +Valid.SetTgl(tgl_expired.getSelectedItem().toString()) + "'","No.Inventaris");//tambah chan 2
                //----------------------------------------------------------
        ...
        if(no_inventaris.getText().trim().equals("")){
            ...
            Valid.textKosong(id_ruang,"Ruangan");
                ...
                Sequel.mengedit("inventaris","no_inventaris='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0)+"'",
                        ...
                        "',harga='"+harga.getText()+"',status_barang='"+status_barang.getSelectedItem()+"',id_ruang='"+id_ruang.getText()+"',no_rak='"+no_rak.getSelectedItem()+"',no_box='"+no_box.getSelectedItem()+"',tgl_kalibrasi='" + Valid.SetTgl(tgl_kalibrasi.getSelectedItem().toString()) +"',tgl_expired='" + Valid.SetTgl(tgl_expired.getSelectedItem().toString()) +"'");//tambah chan 2
                //----------------------------------------------------------
                no_inventaris.requestFocus();
            tampil();
            emptTeks();
...
private void ppBarcodeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBarcodeBtnPrintActionPerformed
    ...
    private void tgl_expiredKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tgl_expiredKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tgl_expiredKeyPressed

    private void tgl_kalibrasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tgl_kalibrasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tgl_kalibrasiKeyPressed
    ...
    */
    ...
    private widget.Tanggal tgl_expired;
    private widget.Tanggal tgl_kalibrasi;
    ...
    public void tampil() {
        try {
            ps=koneksi.prepareStatement("select inventaris.no_inventaris,inventaris_barang.kode_barang, inventaris_barang.nama_barang, "+
                        ...
                        "inventaris_kategori.nama_kategori, inventaris_jenis.nama_jenis,inventaris.asal_barang,inventaris.tgl_pengadaan,inventaris.tgl_kalibrasi,inventaris.tgl_expired,"+//tambah chan 2
                        ...
                        "or inventaris.tgl_expired like '%"+TCari.getText().trim()+"%' or inventaris.status_barang like '%"+TCari.getText().trim()+"%' "+//tambah chan 1
                        "or inventaris.tgl_kalibrasi like '%"+TCari.getText().trim()+"%' or inventaris.status_barang like '%"+TCari.getText().trim()+"%' "+//tambah chan 2        
             ...
             try{            
                ...
                String statusExpired = "";
                    ...
                    LocalDate expiredDate = LocalDate.parse(tglExpiredStr, formatter);

                    long daysBetween = ChronoUnit.DAYS.between(today, expiredDate);
                    if (daysBetween > 0) {
                        statusExpired = daysBetween + " hari lagi expired";
                    } else if (daysBetween == 0) {
                        statusExpired = "Hari ini expired";
                    } else {
                        statusExpired = "Sudah lewat " + Math.abs(daysBetween) + " hari";
                    }
                } else {
                    statusExpired = "Tidak diketahui";
                }
                     tabMode.addRow(new Object[]{rs.getString("no_inventaris"),
                                    ...
                                    rs.getString("no_rak"),
                                    rs.getString("no_box"),
                                    rs.getString("tgl_kalibrasi"),//tambah chan 1
                                    rs.getString("tgl_expired"),//tambah chan 2
                                    statusExpired//tambah chan 3
                                    });//tambah chan 2
